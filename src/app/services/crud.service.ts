...
export class CrudService {
  ...
  readonly db_name: string = "urnaEletro.db";
  readonly db_table: string = "userTable";
  USERS: [{user_id: '', name: '', codigo: '', qntvotos: ''}] ;
  Votos: number;
  constructor(
    ...
    public insertCandidate(){
      this.dbInstance.executeSql(`
      INSERT INTO ${this.db_table} (name, codigo, qntvotos) VALUES ('Lula', 13, 0), ('Bolsonaro', 17, 0), ('Moro', 20, 0)`, [])
      .then((res) => {
        alert("Sucess");
        this.USERS = res;
      }, (e) => {
    ...
    public getCandidates() {
      return this.dbInstance.executeSql(`SELECT * FROM ${this.db_table}`, []).then((res) => {
        this.USERS = [{user_id: '', name: '', codigo: '', qntvotos: ''}];
